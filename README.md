...
bitcore-message-dwcash adds support for verifying and signing dwcash messages in [Node.js](http://nodejs.org/) and web browsers.
...
```sh
npm install bitcore-message-dwcash
```

```sh
bower install bitcore-message-dwcash
```
